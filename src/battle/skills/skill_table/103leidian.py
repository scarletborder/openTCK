...
class SkillLeidian(MultiAttackSkill):
    ...
    def NewSkill(
        ...
        if len(args) > 0:
            ...
            return True, SkillLeidian(caster, [], game), ""
...
Skill_Table[SkillLeidian.GetSkillID().value] = SkillLeidian
Skill_Name_To_ID[SkillLeidian.GetName()] = SkillLeidian.GetSkillID().value
