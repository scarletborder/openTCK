...
print("所有人使用一次积点")
game.OnRoundStart()
csk.ChooseSkillById(1, 0, 1, 301, game)
csk.ChooseSkillById(2, 0, 1, 301, game)
csk.ChooseSkillById(3, 0, 1, 301, game)
game.OnRoundEnd()
print(game.GetStatus())
...
game.OnRoundStart()
ok, msg = csk.ChooseSkillById(1, 2, 1, 1, game)
print(msg)
ok, msg = csk.ChooseSkillById(2, 1, 1, 2, game)
print(msg)
ok, msg = csk.ChooseSkillById(3, 1, 1, 3, game)
print(msg)
game.OnRoundEnd()
print(game.GetStatus())
